...
cout <<" Tuliskan berapa angka yang ingin Anda jumlahkan!  ";  
cin >> n;  
cout << " Masukkan angka yang ingin dijumlahkan (setiap menulis satu angka, klik enter): \n";  
for (i = 1; i <= n; i++)  
{  
cin >> number;  
sum = sum + number;  
}  
cout << "\n Hasil dari penjumlahannya adalah "<< sum;  
}  
void sub()  
{  
int num1, num2, z;  
    ...
    do  
{
    cout <<"\n1 = Penjumlahan"  
            ...
            "\n7 = Faktorial"
            "\n8 = Exit"  
            "\n \n Masukkan pilihan kalkulator yang ingin Anda gunakan: ";  
            cin >> opr; 
